...
<body>
	<div class="header">
		...
		<h1 id="big-title">关键字搜索：${keyWord }</h1>
	...
	<div id="content">
		<div class="block" style="border-radius: 6px 6px 0 0;">
			<div class="grid-1-2-1">
				<div></div>
				<div id="main-content"
					style="min-width: 950px; margin-top: 100px; margin-bottom: 40px;">
					<c:choose>
						<c:when test="${fn:length(pageInfo.list)==0}">
							<h1 style="text-align: center;">暂无记录</h1>
						</c:when>
						<c:otherwise>
								...
								<div class="block block2">
									<div class="grid-5-7" style="height: 250px;">
										...
										<div class="main-15">
											<h4>
												<a
													href="${pageContext.request.contextPath}/portal/type.action?typeId=${entity.typeId}">${entity.name}</a>
											</h4>
											<h2>
												<a
													href="${pageContext.request.contextPath}/portal/content.action?id=${entity.id}"><b>"${entity.title}"</b></a>
											</h2>
											<p>
												"${entity.contentText}" <a
													href="${pageContext.request.contextPath}/portal/content.action?id=${entity.id}">
													阅读更多…</a>
											</p>
