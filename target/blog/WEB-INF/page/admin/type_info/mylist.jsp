								...
								<tbody>
									<c:forEach items="${list}" var="entity">
										<tr>
											...
											<td><input type="text" value="${entity.sort}"
												class="text" name="sort" data-type="正整数" error-msg="必须输入正整数" /></td>
											<td><input type="text" class="text" name="name" data-type="必填" 
											placeholder="请输入分类名称" value="${entity.name}" /></td>
										</tr>
