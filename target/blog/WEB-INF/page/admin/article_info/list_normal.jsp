					...
					<div class="block">
						...
						<div class="main-20">
							...
							<div style="text-align: right; margin-bottom: 14px;">
								<!-- 文章分类 -->
								<select id="type_id" class="no-shadow" style="width: 8%;">
								...
								<input type="text" id="date2" class="date" style="width: 250px;"
									value="" readonly />

								<!-- search title -->
								<input id="title" type="text" value="${keyWord}" class="text" placeholder="请输入关键字">
								<!-- search button -->
								<button class="button blue" onclick="search()">
									...
									<c:choose>
										...
										<c:otherwise>
											<c:forEach items="${pageInfo.list}" var="entity"
												varStatus="status">
												<tr>
													<td><input type="checkbox" class="fill listen-1-2"
							...
							<div class="block no-shadow">
								...
								<div class="main" style="margin-bottom: 200px;">
									<label zoom="1.2">
										<input type="radio" class="fill" name="radio" value="move" checked="checked"/> 批量移动到分类  </label> 
									...
									<label zoom="1.2"><input type="radio" class="fill" name="radio" value="recycle" /> 批量删除  </label> <br />
									<button id="submit" class="button green" style="margin-top: 20px;">
										<span class="icon-check"></span> 提交
									</button>
								</div>
