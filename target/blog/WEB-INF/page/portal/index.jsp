...
<body>
	<div class="header">
		...
		<h1 id="big-title" style="font-family:fantas;">博知天下</h1>
	</div>
						...
						<div class="block block2">
							<div class="grid-5-7" style="height: 250px;">
								...
								<div class="main-15">
									...
									<h2>
										<a href="${pageContext.request.contextPath}/portal/content.action?id=${entity.id}"><b>"${entity.title}"</b></a>
									</h2>
									<p>
										"${entity.contentText}"
										<a href="${pageContext.request.contextPath}/portal/content.action?id=${entity.id}"> 阅读更多…</a>
									</p>
...
<script>
	...
	javaex.page({
		...
		callback:function(rtn) {
			...
			window.location.href = "${pageContext.request.contextPath}/portal/index.action?pageNum="+num;
		}
	});
</script>
</html>
