			...
			<div class="grid-1-2-1">
				...
				<div id="main-content" style="min-width: 950px;margin-top: 100px;margin-bottom: 40px;">
					<div class="content-header">
						<a href="${pageContext.request.contextPath}/portal/index.action"><span class="icon-home active"> 主页</span></a>
						<span class="divider">/</span>
						<span class="active"><a href="${pageContext.request.contextPath}/portal/type.action?typeId=${articleInfo.typeId}">分类：${articleInfo.name}</a></span>
						<span class="divider">/</span>
						<span>标题：${articleInfo.title}</span>
						<p style="font-family: cursive;color: black;">浏览量：${articleInfo.viewCount}</p>
					</div>
