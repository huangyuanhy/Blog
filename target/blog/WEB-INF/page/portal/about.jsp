			...
			<div class="grid-1-2-1">
				...
				<div id="main-content" style="min-width: 950px;margin-top: 50px;margin-bottom: 40px;">
					<div class="content-header">
						<p style="font-family: sans-serif;color: maroon; margin-right: 30%;">QQ：624119327</p>
						
						<p style="font-family: sans-serif;color: maroon;">phone：15528799071</p>
					</div>
					
					<div class="block block2">
						<div class="main-0">
							<p>2012.09-2016.07：</p>
							<blockquote><p>就读于黑龙江科技大学材料学院，学习成绩名列前茅，获得诸多荣誉和奖项，如国家奖学金、省三好学生等。同时对互联网行业保持强烈的好奇心，关注行业发展动态，阅读相关专业书籍。</p></blockquote>
							
							<p>2016.09-至今：</p>
							<blockquote><p>就读于四川大学制造学院，进一步学习计算机基础知识，已学习JavaWeb开发的相关知识，下一步将学习python、tensorflow等数据挖掘方面的知识，未来致力于软件行业。</p></blockquote>
							<p>关于此项目</p>
							<blockquote><p>此项目是基于SSM框架开发的一个博客系统，并没有实现注册功能，如果您想看后台相关模块的设计，可以使用如下账户进行登陆体验：账户：huangyuan;密码：925925</p></blockquote>
